package atividade4.visual_Search;
...
public class App {
    public static void main(String[] args) {
        ...
        if(endpoint == null || key == null){
            ...
            System.out.println("Credenciais aprovadas!");
        }
        ...
        try{
            ImageAnalysisResult result1 = client.analyze(
                BinaryData.fromFile(new File("proknow\\src\\main\\resources\\img\\JUNTAS.jpg").toPath()),
                Arrays.asList(VisualFeatures.PEOPLE),
                null);
            
            ImageAnalysisResult result2 = client.analyze(
                BinaryData.fromFile(new File("proknow\\src\\main\\resources\\img\\vdg.jpeg").toPath()),
                Arrays.asList(VisualFeatures.PEOPLE),
                null);
    ...
    //função para imprimir resultados dos métodos anteriores
